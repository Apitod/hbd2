...
$('document').ready(function () {
	...
	$('#wish_message').click(function () {
		...
		$('#b66').animate({ top: 240, left: vw + 300 }, 500); // Unused but kept for safety
		$('#b77').animate({ top: 240, left: vw + 400 }, 500); // Unused but kept for safety
	...
	$('#story').click(function () {
		...
		// msgLoop(0); 
		// New logic for letter
		$('#letter-container').fadeIn('slow');
	});

	// Make the envelope interactive
